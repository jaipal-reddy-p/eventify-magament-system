...
/**
 * Controller handling authentication features: - Login with JWT cookie - Logout
...
public class AuthController {
	...
	/**
	 * Login with email and password. On success: generates JWT, stores it in
	 * HttpOnly cookie.
	 */
	@PostMapping("/login")
	...
	/**
	 * Logout the user. Deletes JWT from DB and clears the cookie.
	 */
	@PostMapping("/logout")
